...
import nl.mranderson.pokefeeds.news.data.store.NewsCache;
...
//    private final Context context;
    ...
    NewsDataStoreFactory(@NonNull NewsCache newsCache) {
...
//        }
        ...
        if (!this.newsCache.isExpired() && this.newsCache.isCached()) {
            newsDataStore = new DiskUserDataStore(this.newsCache);
        } else {
            newsDataStore = new CloudUserDataStore();
        }
